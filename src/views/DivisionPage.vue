      ...
      <v-col class="max-w-full lg:max-w-[55%] px-0">
        <v-list class="pt-0">
          ...
          <div class="border-b p-8">
            ...
            <div class="flex items-center space-x-2">
              <span>Tag数量:</span>
              <v-btn @click="setTagsCount(3)">少</v-btn>
              <v-btn @click="setTagsCount(9)">多</v-btn>
            </div>
          </div>

          <v-list-item v-for="(content, index) in contents" class="pl-16 py-5 border-b-2 flex-col text-left">
            <template v-if="mode === 1">
              <div class="w-full flex justify-between my-1">
                ...
                <SpecialFlagChip :text="specialTag" :color="'red'" v-if="index === 0"></SpecialFlagChip>
              </div>
...
const reply = "用在树上的生活方式体现个体的超越性，保持婞直却又不拘泥于所谓“遗世独立”的单向度形象。这便是卡尔维诺为我们提供的理想期望范式。生活在树上——始终热爱大地——升上天空。";
